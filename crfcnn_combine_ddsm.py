...
debug = False #False
savename = str(lr)+str(totalepoch)+str(atepsilon)+'1nnlrfsave'+str(5)+modelname+'norm'
fusion=None #'late' #None #'late'
saveperepoch = True #False #True #True # True
savefreq = 200
print(savename)
boxheight = 40
boxwidth = 40
...
traindatapath = './train1/'
trainlabelpath = './train1/'
testdatapath = './test1/'
testlabelpath = './test1/'
...
if __name__ == '__main__':
  ...
  if modelname[3:7] == 'comb':
    ...
    paras = init(nhid1=9, nhid2=12, nhid3=588, lrf1=4, lrf2=4, lrf3=7)
  if modelname == 'cnn':
  ...
  #with tf.Session() as sess:
    ...
    for epoch in range(0,totalepoch):
      randindex = np.random.permutation(batchsize*12)
      ...
      for iindex in range(12):
        ...
        trainloss += energy
        trainacc += acc
      print('epoch'+str(epoch)+', '+str(trainloss/12)+' '+str(trainl2/12)+' '+str(trainacc/12)+' '+str(traindi/12))
      ...
      print('epoch'+str(epoch)+', '+str(testenergyval/3)+' '+str(testacc/3)+' '+str(testdi))
      if traindi/12>0.90 and testdi > besttedi:
      ...
      if traindi/12 > 0.885:
      	lrbig = lr
      trenerls.append(trainloss/12)
      traccls.append(trainacc/12)
      trdils.append(traindi/12)
      teenerls.append(testenergyval/12)
      teaccls.append(testacc/12)
